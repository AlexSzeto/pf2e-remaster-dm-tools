...
const test = () => {
  fetch('http://localhost:11434/api/generate', {
    ...
    body: JSON.stringify({
      ...
      stream: false,
      prompt: 
`Generate a list of 10 random fantasy names fulfilling the criteria "${document.querySelector('[name="nameCriteria"]').value}" and output it as a JSON array.
...
render(html`
  ...
  <div class="subsection vertical-list">
    ...
    <input name="nameCriteria" type="text" placeholder="human male" value="human male" />
