...
// Format: level, total treasure, permanent items (level-count), consumeable items (level-count), extra party gp, extra gp per character (outside of default 4 characters)
